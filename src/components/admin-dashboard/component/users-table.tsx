...
import { getUsersRequest } from "../../../redux/effects/usersEffects";
...
const Users: React.FC<IUserProps> = ({ propsUser, getUsersRequest }) => {
          ...
          <ul className="pagination" style={{ margin: 0 }}>
            <li className="page-item" >
              <Link
                to="#"
                className="page-link"
                onClick={() => setPage(prev => prev >= numberOfPages.length ? prev : prev + 1)}
              >
                Prev
              </Link>
            </li>
